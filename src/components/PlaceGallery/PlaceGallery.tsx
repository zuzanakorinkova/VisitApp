  ...
  return (
    ...
    <View style={styles.modal}>
      <View style={styles.modalContainer}>
        <Pressable onPress={closeDetail} style={styles.iconContainer}>
          <View style={styles.icon}>
            <Ionicons name="close" size={24} color={colors.colors.text} style={{padding: 10}}/>
  
          </View>
          </Pressable>

          <Image source={{uri: route.params.images[imageIndex]}} style={styles.modalImage} />
      ...
      <FlatList
        ...
        numColumns={2}
        renderItem={({item, index}) => <Pressable style={styles.imagePress} onPress={() => showDetail(index)}>
